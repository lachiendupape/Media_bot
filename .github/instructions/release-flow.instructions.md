...
applyTo: ".github/workflows/release.yml,docker-compose.prod.yml,scripts/deploy-prod.ps1,.github/workflows/deploy-dev.yml,.github/workflows/promote-to-prod.yml,scripts/deploy-dev.ps1"
...
- Use a dev-first promotion sequence for release changes: publish image -> deploy to dev -> validate -> manually promote to prod.
